  ...
  return (
    <div className="flex flex-row items-center justify-between h-28">
...

      {
        ...
        <div ref={wrapperRef} className="absolute top-0 w-full h-48 bg-white">
          ...
          <div className="flex flex-col items-center justify-around h-full pt-5">
            ...
            <a onClick={() => setOpenNav(false)} href="#product" className="text-lg font-semibold text-blue-800 transition-all hover:text-orange-500">Become A Partner</a>
      ...
      <div className="flex justify-around w-2/5 mr-12 lg:visible sm:invisible">
        <Link to="/" className="text-lg font-semibold text-blue-800 transition-all hover:text-orange-500">Home</Link>
        <Link to="/partner" className="text-lg font-semibold text-blue-800 transition-all hover:text-orange-500">Become A Partner</Link>
        <Link to="/faq" className="text-lg font-semibold text-blue-800 transition-all hover:text-orange-500">Faq</Link>
        <Link to="/" className="text-lg font-semibold text-blue-800 transition-all hover:text-orange-500">Contact</Link>
      </div>
